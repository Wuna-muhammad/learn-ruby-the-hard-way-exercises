...
class Room
  ...
  BOMB_END = Room.new("The End", """
  The lock buzzes one last time and then you hear a sickening
  melting sound as the mechanism is fused together.
  You decide to sit there,
  ...
  # Whitelist of allowed room names. We use this so that
  # bad people on internet can't access random variables
  # with names. YOu can use Test::constants and Kernel.cont_get
  # too.

...
class TestMap < Test::Unit::TestCase
  ...
  def test_gothon_game_map()
    # Central corridor
    assert_equal(Map::SHOOT_END, Map::START.go('shoot!'))
    assert_equal(Map::DODGE_END, Map::START.go('dodge!'))
    assert_equal(Map::LASER_WEAPON_ARMORY, Map::START.go('tell a joke'))

    # Laser weapon armory.
    assert_equal(Map::THROW_END, Map::LASER_WEAPON_ARMORY.go('throw the bomb'))
    assert_equal(Map::ESCAPE_POD, Map::LASER_WEAPON_ARMORY.go('slowly place the bomb'))
    assert_equal(Map::BOMB_END, Map::LASER_WEAPON_ARMORY.go('*'))

    # The Bridge.
    assert_equal(Map::THROW_END, Map::THE_BRIDGE.go('throw the bomb'))
